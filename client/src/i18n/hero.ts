...
const copy: Record<Locale, HeroCopy> = {
  de: {
    ...
    h1Tagline: 'Enterprise‑Plattform für Chat, Agenten & Automatisierung',
    subcopy:
      'Baue GenAI‑Workflows mit RAG, Actions/MCP und Code. Schnell. Sicher. Skalierbar.',
  ...
  en: {
    ...
    h1Brand: 'SIGMACODE AI',
    h1Tagline: 'Enterprise platform for chat, agents & automation',
    subcopy:
      'Build GenAI workflows with RAG, Actions/MCP and code. Fast. Secure. Scalable.',
