...
export const buttonStyles: Record<UIButtonVariant, string> = {
  ...
  secondary:
    'inline-flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium transition hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-0 dark:focus-visible:ring-offset-0 text-teal-300 border border-teal-400/30 bg-white/0 dark:bg-white/0 hover:bg-teal-500/10 focus-visible:ring-teal-500/70 dark:focus-visible:ring-teal-300/60',
  ghost:
    'inline-flex items-center gap-2 rounded-lg px-3 py-1.5 text-[13px] font-medium transition hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-0 dark:focus-visible:ring-offset-0 text-teal-300 border border-teal-400/30 bg-transparent hover:bg-teal-500/10 hover:text-white focus-visible:ring-teal-500/70 dark:focus-visible:ring-teal-300/60',
};
